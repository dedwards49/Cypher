...
//--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
#pragma ModuleName=DE_MultiRamp
...
Static function Start()
	...
	variable rep,zerovolt,pvol,startmultivolt,endmultivolt,totaltime,DataLength,outdecirate,runFast
	...
	TotalTime=DE_MultiRamp#CustomRamp2(RampInfo,SlowInfo,CustomWave2,startmultivolt,endmultivolt)
...
//	IR_XSetInWavePair(1,"7,7","Cypher.Input.FastA",DefVolts_slow,"Cypher.LVDT.Z",ZSensorVolts_slow,"", decirate)
	...
	td_SetRamp(str2num(SlowInfo[%TimeToStart][0]), "PIDSLoop.5.Setpointoffset", 0, (startmultivolt- td_rv("PIDSLoop.5.Setpoint")), "", 0, 0, "", 0, 0, "DE_MultiRamp#Init("+num2str(outdecirate)+")")
	
end

//--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

Static function Init(outdecirate)
	...
	IR_XSetInWavePair(1,"7,7","Cypher.Input.FastA",DefVolts_slow,"Cypher.LVDT.Z",ZSensorVolts_slow,"", -decirate)
	IR_xSetOutWave(2,"7,7","$DwellLoop2.Setpointoffset",CustomWave2,"DE_MultiRamp#Repeat()",outdecirate)
	td_WS("Event.7","Once")
...
//	ErrorStr += IR_xSetOutWave(2,"7","$DwellLoop2.Setpointoffset",CustomWave2,"DE_MultiRampRepeat()",outdecirate)
	...
	TotalTime=DE_MultiRamp#CustomRamp2Time(RampInfo,RefoldSettings,CustomWave2,startmultivolt,endmultivolt)
...
Static function EndRamps()
//td_setramp
wave/t RefoldSettings

			td_SetRamp(str2num(RefoldSettings[%TimeToStart][0]), "PIDSLoop.5.Setpointoffset", 0, 0, "", 0, 0, "", 0, 0, "DE_MultiRamp#StartFinal()")
end

Static function StartFinal()
	wave customwave3 
	wave ZSensor_Final
	wave DefV_Final 
	wave/t RefoldSettings
	...
	IR_xSetOutWave(2,"15","$DwellLoop2.SetpointOffset",CustomWave3,"DE_MultiRamp#EndFinal()",outdecirate)
	IR_XSetInWavePair(1,"15","Deflection",DefV_Final,"Cypher.LVDT.Z",ZSensor_Final,"",-50/str2num(RefoldSettings[%DataRate][0]))
	td_ws("Event.15","once")
end

Static function EndFinal()
...
//--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
Static Function CustomRamp2(RampInfo,RefoldSettings,CustomWave2,startmultivolt,endmultivolt)
...
Static Function CustomRamp2Time(RampInfo,RefoldSettings,CustomWave2,startmultivolt,endmultivolt)
...
Static Function CustomRamp3(RampInfo,RefoldSettings,CustomWave3)
	wave/t RampInfo
	wave/t RefoldSettings
	wave CustomWave3
...
Static function MakeMultiRamp(a0,a1,a2,a3,a4,a5,a6,a7,a8,a9,a10,a11,a12,a13,wpar,c0,c1,c2,c3,c4,c5,c6,c7)
