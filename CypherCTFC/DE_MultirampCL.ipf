...
#pragma ModuleName=DE_MultiRampOL
...
//	
	...
	td_SetRamp(str2num(RefoldSettings[%TimeToStart][0]), "PIDSLoop.5.Setpointoffset", 0, (startmultivolt- td_rv("PIDSLoop.5.Setpoint")), "", 0, 0, "", 0, 0, "DE_MultiRampOL#Init("+num2str(outdecirate)+")")
end
...
Static function Init(outdecirate)
	...
	IR_xSetOutWave(2,"7,7","Output.z",CustomWave2,"DE_MultiRampOL#Repeat()",outdecirate)
...
Static function FastDone()//Resets the fast capture...not sure if necessary will have to check
	Wave/T RepeatInfo=root:DE_CTFC:RepeatSettings
	Wave/T RampInfo=root:DE_CTFC:RampSettings
	Wave/T TriggerInfo=root:DE_CTFC:TriggerSettings
	wave/t RefoldSettings	
